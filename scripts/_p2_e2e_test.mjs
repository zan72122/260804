...
const SHOTS_DIR = '/tmp/claude-0/-home-user-260804/2eeaee21-2a8b-56e3-9168-8c4b4d89a82d/scratchpad/shots-p2-e2e';
...
async function clickHud(page, id) {
  await page.click(`button[aria-label="${id}"]`, { force: true });
  await sleep(60);
}
