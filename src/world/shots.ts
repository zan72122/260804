...
export const PORTRAIT: Record<ShotName, Shot> = {
  ...
  action: { pos: [M + 0.58, 0.98, 2.20], target: [M + 0.18, 0.58, 0.05], fov: 44, drift: 0.5 },
  ribbonMacro: { pos: [M + 0.50, 0.94, 1.88], target: [M + 0.10, 0.62, 0.05], fov: 40, drift: 0.7 },
  ribbonPick: { pos: [M + 0.40, 1.48, 3.95], target: [M - 0.16, 1.00, 0.05], fov: 50, drift: 0.5 },
  bath: { pos: [B, 2.20, 1.58], target: [B, 0.34, -0.02], fov: 54, drift: 0.35 },
  pickup: { pos: [B, 1.72, 1.92], target: [B, 0.26, -0.04], fov: 52, drift: 0.4 },
  dewax: { pos: [S - 0.10, 1.60, 1.62], target: [S - 0.16, 0.46, 0.02], fov: 48, drift: 0.5 },
  stain: { pos: [S, 1.80, 1.90], target: [S, 0.46, 0.12], fov: 50, drift: 0.4 },
  mount: { pos: [S, 1.05, 2.16], target: [S - 0.02, 0.12, 0.94], fov: 50, drift: 0.4 },
...
export const LANDSCAPE: Record<ShotName, Shot> = {
  ...
  action: { pos: [M + 0.55, 0.90, 1.70], target: [M + 0.15, 0.55, 0.05], fov: 44, drift: 0.5 },
  ribbonMacro: { pos: [M + 0.40, 0.86, 1.45], target: [M + 0.02, 0.58, 0.05], fov: 42, drift: 0.7 },
  ribbonPick: { pos: [M - 0.03, 1.19, 2.30], target: [M - 0.47, 0.80, 0.05], fov: 46, drift: 0.5 },
  bath: { pos: [B, 1.62, 1.32], target: [B, 0.34, -0.02], fov: 48, drift: 0.35 },
  pickup: { pos: [B, 1.32, 1.58], target: [B, 0.26, -0.04], fov: 46, drift: 0.4 },
  dewax: { pos: [S - 0.10, 1.26, 1.40], target: [S - 0.16, 0.44, 0.02], fov: 48, drift: 0.5 },
  stain: { pos: [S, 1.42, 1.55], target: [S, 0.44, 0.12], fov: 48, drift: 0.4 },
  mount: { pos: [S, 0.92, 1.92], target: [S - 0.02, 0.10, 0.94], fov: 48, drift: 0.4 },
