...
export const PORTRAIT: Record<ShotName, Shot> = {
  ...
  ribbonMacro: { pos: [M + 0.50, 1.30, 2.55], target: [M + 0.02, 1.00, 0.05], fov: 38, drift: 0.7 },
...
export const LANDSCAPE: Record<ShotName, Shot> = {
  ...
  ribbonMacro: { pos: [M + 0.30, 1.10, 1.95], target: [M - 0.18, 0.80, 0.05], fov: 40, drift: 0.7 },
  ribbonPick: { pos: [M + 0.08, 1.48, 2.85], target: [M - 0.52, 0.98, 0.05], fov: 46, drift: 0.5 },
